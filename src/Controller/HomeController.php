        ...
        $endpoints = [
            'AUTENTICACIÓN' => [
                ...
                [
                    ...
                    'público' => true,
                    'body' => ['email' => 'string', 'password' => 'string', 'apikey' => 'string', 'latitud' => 'float', 'longitud' => 'float'],
                    'response' => ['usuario_id' => 'int', 'username' => 'string', 'email' => 'string', 'token' => 'string', 'chat_general_token' => 'string (CHAT_PUBLICO_GENERAL_TOKEN_FIJO_12345)'],
                    'nota' => 'Retorna el token del chat general para que el usuario pueda unirse automáticamente',
                ],
                [
                    'método' => 'POST',
                    'ruta' => '/api/registro',
                    ...
                    'público' => true,
                    'body' => ['email' => 'string', 'username' => 'string', 'password' => 'string', 'apikey' => 'string', 'latitud' => 'float', 'longitud' => 'float'],
                    'response' => ['nombre' => 'string', 'email' => 'string', 'access_token' => 'string', 'chat_general_token' => 'string (CHAT_PUBLICO_GENERAL_TOKEN_FIJO_12345)'],
                    'nota' => 'Retorna el token del chat general para que el usuario pueda unirse automáticamente',
                ],
                [
                    'método' => 'POST',
            ...
            'ACTUALIZACIÓN' => [
                [
                    ...
                    'público' => false,
                    'body' => ['api_key' => 'string', 'user_token' => 'string', 'token_sala' => 'string (token del chat, puede ser CHAT_PUBLICO_GENERAL_TOKEN_FIJO_12345 para el chat general)', 'ultimo_mensaje_id' => 'int', 'latitud' => 'float (opcional)', 'longitud' => 'float (opcional)', 'ultima_actualizacion' => 'string datetime (opcional)'],
                    'nota' => 'token_sala puede ser el token de un chat privado o CHAT_PUBLICO_GENERAL_TOKEN_FIJO_12345 para el chat general',
                ],
            ],
            'CHAT GENERAL' => [
                [
                    ...
                    'público' => false,
                    'body' => ['api_key' => 'string', 'token_user' => 'string', 'chat_token' => 'string (CHAT_PUBLICO_GENERAL_TOKEN_FIJO_12345)', 'contenido' => 'string'],
                    'nota' => 'El chat_token debe ser: CHAT_PUBLICO_GENERAL_TOKEN_FIJO_12345',
                ],
                [
                    'método' => 'POST',
                    ...
                    'público' => false,
                    'body' => ['api_key' => 'string', 'token_user' => 'string', 'chat_token' => 'string (CHAT_PUBLICO_GENERAL_TOKEN_FIJO_12345)'],
                    'nota' => 'El chat_token debe ser: CHAT_PUBLICO_GENERAL_TOKEN_FIJO_12345',
                ],
            ],
            'CHAT PRIVADO' => [
